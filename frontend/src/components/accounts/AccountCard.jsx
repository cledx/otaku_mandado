 ...
 * glance whether this user has outstanding orders to chase down.
 *
 * @param {{ account: {
 *   id: number,
 *   email: string,
...
export default function AccountCard({ account }) {
  const { email, role, created_at: createdAt, pending_orders: hasPending, pending_orders_count: pendingCount } = account
